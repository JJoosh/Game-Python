...
class Explosion(pygame.sprite.Sprite):
    def __init__(self, center):
        ...
        self.frame_rate = 50  # Velocidad de mi explosion
...
def show_go_screen():
    draw_text(screen, "Stellar Storm", 65, WIDTH // 2, HEIGHT // 4)
    draw_text(
        screen,
        "Usa ← → para moverte",
        27,
...
sonido_explocion = pygame.mixer.Sound("assets/explosion.wav")
...
while running:
    ...
    # Solo mostrara un color negro de fondo
    # screen.fill(BLACK)
